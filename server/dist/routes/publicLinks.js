...
router.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const { target_url: rawTarget, code: maybeCode } = (_a = req.body) !== null && _a !== void 0 ? _a : {};
       ...
       VALUES ($1, $2, NULL, 0, NULL, now())
       RETURNING code, target_url, created_at, total_clicks, last_clicked`, [code, target_url])
            .catch((err) => {
            if (err.code === "23505")
...
router.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const q = yield db_1.pool.query("SELECT code, target_url, created_at, total_clicks, last_clicked FROM links ORDER BY created_at DESC");
...
router.get("/:code", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const q = yield db_1.pool.query("SELECT code, target_url, created_at, total_clicks, last_clicked FROM links WHERE code=$1", [code]);
        if (q.rowCount === 0)
...
router.delete("/:code", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!utils_1.CODE_REGEX.test(code))
            return res.status(400).json({ error: "invalid code" });
        const del = yield db_1.pool.query("DELETE FROM links WHERE code=$1 RETURNING code", [code]);
        if (del.rowCount === 0)
            return res.status(404).json({ error: "not found" });
